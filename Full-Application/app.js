...
const MONGODB_URI =
  'mongodb+srv://yehiahassanain:efoszQPFvYVZGA8o@cluster0.j3razmw.mongodb.net/shop';
...
app.use((req, res, next) => {
  // if this is line there before add the code that stop make infinity reload that still
  // throw Error('Dummy');
  if (!req.session.user) {
    return next();
  }
